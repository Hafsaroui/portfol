$(document).ready(function () {
    ...
    // Hamburger universal overlay menu
    const $menu = $('#menu');
    const $navLinks = $('#nav-links');

    $menu.on('click', function (e) {
        e.stopPropagation();
        if ($navLinks.hasClass('menu-open')) {
            $navLinks.removeClass('menu-open').addClass('hidden');
            $menu.removeClass('fa-times');
        } else {
            $navLinks.removeClass('hidden').addClass('menu-open');
...
var typed = new Typed(".typing-text", {
    strings: [
        ...
        "I am a System defender.",
        "I am a Network explorer.",
        "I am a Threat analyst."
    ],
    loop: true,
    typeSpeed: 60,
    backSpeed: 30,
